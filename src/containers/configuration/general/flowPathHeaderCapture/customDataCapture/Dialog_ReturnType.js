...
var columns = {
  ...
  "field": ['headerName', 'operationName', 'operatorName', 'id']
};
...
class Dialog_ReturnType extends React.Component {
  ...
  this.props.addReturnType(data,this.props.methodBasedCustomData.methodBasedId);
  }
}
...
/**********add component fields************** */
    ...
    handleCancel(){
        this.props.toggleReturnTypeDialog({});
    }
...
onBeforeSaveCell(row, cellName, cellValue){
  ...
  render() {
    ...
    return (
      <div>
        <Dialog
          title="Return Type Configure"
          actions={actions}
          modal={false}
          open={this.props.methodBasedCustomData.openReturnTypeDialog}
      ...
      <Paper zDepth={2} style={{background:'rgba(0,0,0,0.80)', color:'#FFF'}}>  
         ...
         */
          ...
          <DataGrid data={this.props.methodBasedCustomData.returnTypeData}
            pagination={false}
            ref="appTable"
            column={columns}
...
function mapStateToProps(state) {
    console.log("Dialog_return type---",state.methodBasedCustomData)
  return {
...
export default connect(mapStateToProps, mapDispatchToProps)(Dialog_ReturnType);
